...
- Optional: provide a separate Circle x402 buyer key and spend limits if paid Marketplace evidence should be enabled for live demos. Fund Gateway balance for Gateway-batched sellers and normal Base USDC for standard exact x402 sellers.
