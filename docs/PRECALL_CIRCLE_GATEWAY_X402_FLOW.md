...
3. **Request Evidence:** The worker calls Circle Marketplace services for AISA Twitter/X social search, AISA Tavily web/news search, and Stable Enrich Firecrawl page evidence.
...
9. **Receive Evidence:** AISA, Tavily, and Firecrawl return paid marketplace evidence to Precall.
