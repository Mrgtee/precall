...
3. **Pay for Evidence:** Gateway-batched Circle Marketplace sellers quote the resources, and Circle Gateway x402 pays the required USDC nanopayment within configured spending limits.
4. **Receive Paid Evidence:** AISA returns Twitter/X social signals and Tavily web/news results. Incompatible marketplace schemes are recorded and excluded from analysis.
