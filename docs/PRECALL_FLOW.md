...
3. **Pay for Evidence:** Circle Marketplace sellers quote the resources, and Circle Gateway x402 pays the required USDC nanopayment within configured spending limits.
4. **Receive Paid Evidence:** AISA returns Twitter/X social signals and Tavily web/news results, while Stable Enrich Firecrawl returns source-backed page evidence.
